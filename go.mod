module github.com/p-jo/matterbridge
...
require (
	...
	github.com/dyatlov/go-opengraph/opengraph v0.0.0-20210112100619-dae8665a5b09 // v0.0.0-20220524092352-606d7b1e5f8a indirect
